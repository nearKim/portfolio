...
subtitle: 서울대학교 중앙 커피동아리 Caffein이 사용할 웹사이트를 제작한다
...
## 기존 상황
- 학기당 가입 신청인원은 평균적으로 200~300명정도이고 모든 절차를 마치고 가입완료되는 인원은 매 학기 약 100명 이상이다.
- 가입신청시 설문과 자기소개는 Google Docs로 관리된다. 새로운 신청이 들어올 때마다 운영진이 확인해야 한다.
...
- 이상 모든 활동에 동아리 운영진의 리소스가 과다하게 투여된다.

## 예상 효과
- 가입절차를 회비입금을 제외하고 완전 자동화함으로써 운영진의 부담을 획기적으로 경감한다.
